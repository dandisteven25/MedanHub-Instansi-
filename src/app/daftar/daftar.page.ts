  ...
  async signup(){
    firebase.auth().createUserWithEmailAndPassword(this.email, this.password).then(
      async (data)=>{
        ...
        await this.databaseService.setInstansi(data.user.uid,{"username": this.username, "fullname": this.fullname, "contactnumber":this.contactnumber,"email":this.email, "password":this.password})
